...
module.exports = class ClientLanguage extends Loader {
  constructor(client) {
    ...
    Object.defineProperty(this, 'language', {
      value: {
        i18next: i18next, rootDir: 'pt-BR', langs: [], files: [],
        reset: async (dir) => this.client.language = await this.loadLanguage(dir)
      },
      writable: true
    })
  }
  ...
  async loadLanguage(dirPath = 'src/locales') {
    ...
    return i18next
      ...
      .init({
        ns: ['commands', 'descriptions', 'errors', 'permissions', 'commons', 'categories', 'regions'],
